package com.sitech.paas.tracer.utils;
...
import com.sitech.paas.tracer.Constants;
...
//        return metrics.widthPixels + "*" + metrics.heightPixels;
     ...
     * @return
     */
    public static long getSysAvailableMemory() {
        ActivityManager mActivityManager = (ActivityManager) SitechApm.trackContext.getSystemService(ACTIVITY_SERVICE);
        //获得MemoryInfo对象
...
//            存储卡已经被移除
     ...
     * @return
     */
    public static int getRemainPower(Context context) {
        return Constants.INSTANCE.getPower();
...
//        return activity.getRequestedOrientation();
        Configuration newConfig = SitechApm.trackContext.getResources().getConfiguration();
    ...
    public static String getUUid() {
        String str = System.currentTimeMillis() + getDeviceId(SitechApm.trackContext) + 123;
        return md5(str);
    }
}
